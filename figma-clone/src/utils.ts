...
import {type Camera, type Color, type Layer, LayerType, type XYWH, type PathLayer, Side, type Point} from "./types";
...
export function resizeBounds(bounds: XYWH, corner:Side,side: Side, point: Point): XYWH {
    const result = {
        x: bounds.x,
        y: bounds.y,
        width: bounds.width,
